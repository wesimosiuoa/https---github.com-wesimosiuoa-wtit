<?php
    ...
    if (isset ($_POST['submit'])){
        ...
        instrcutor_signin ($username, $pwd);
    }
?>
...
<div class="container-md">
    ...
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">IDENTITY #</label>
    ...
    <!-- <a href="../public/sign-up.php" class="btn btn-danger"> Create Account </a> -->
    </form>
</div>
