...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="../img/WhatsApp Image 2024-02-13 at 15.45.22_b7bce11a.jpg" alt="Logo"> Instructor Panel
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="../public/panel.instructor.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../public/tuitor-courses.php"><i class="fas fa-book"></i> Courses</a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link" href="../public/instructors.php"><i class="fas fa-chalkboard-teacher"></i> Instructors</a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link" href="../public/tuitor-students.php"><i class="fas fa-graduation-cap"></i> Students</a>
                </li>
                <!-- <li class="nav-item">
